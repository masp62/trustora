...
import { getPendingAdminQueue } from "@/lib/admin-dashboard";
...
export default async function AdminDashboardPage() {
  ...
  const pendingReports = await getPendingAdminQueue();
    ...
    <main className="flex flex-1 px-4 py-10 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 sm:py-12">
      <section className="mx-auto w-full max-w-[1760px] space-y-6 rounded-[2rem] border border-gray-200 bg-white p-6 shadow-sm sm:p-10">
        <div>
          ...
          <h1 className="mt-3 font-heading text-3xl leading-tight text-gray-900 sm:text-5xl">Report queue</h1>
          <p className="mt-3 text-gray-700">
            Review pending reports and take moderation actions for reported posts and comments.
          </p>
        </div>
