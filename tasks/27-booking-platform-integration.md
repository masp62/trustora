# #27 â€” Booking Platform Integration (Booking.com / Airbnb)

**Type:** HITL
**Blocked by:** #26 â€” Verified Stay Review Authenticity

## What to build

Integrate external booking platforms (e.g., Booking.com and Airbnb) so booking data can be imported and linked to Trustora users and listings. The integration should enable verification flows based on real reservation records and provide a reliable sync mechanism for booking status updates.
...
- [ ] Imported reservation records are mapped to the correct Trustora user and listing using deterministic matching rules
...
- [ ] Reservation status updates from the external platform (e.g., confirmed, canceled, completed) are reflected in Trustora after sync
...
- #26 â€” Verified Stay Review Authenticity
